...
public class ItemDatabase : MonoBehaviour {
	...
	void Awake(){
		...
		items.Add (new Item ("Amulet", 1, "Very Strange", 1, 0,1, Item.ItemType.Armour));
		items.Add (new Item ("Potion", 2, "This will heal ", 0, 0,0, Item.ItemType.Consumable));
		items.Add (new Item ("Axe", 3, "This is a sturdy axe", 1, 0,0, Item.ItemType.Weapon));
		...
		items.Add (new Item ("Light Armour", 8, "This weighs nothing", 0, 3,3, Item.ItemType.Armour));
		...
		items.Add (new Item ("Silver Armour", 11, "Very sturdy armour", 0, 3,3, Item.ItemType.Armour));
